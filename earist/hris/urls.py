...
urlpatterns = [
        ...
        path('user_account/', views.u_accountSettings, name="u_account"),
        path('user/', views.userPage, name='user-page'),
        path('upload/', views.upload_file, name='upload_file'),
        path('user_upload/', views.u_upload_file, name='u_upload_file'),
        ...
        path('user_search/', views.u_search_records, name='u_search_records'),
        path('dtr/', views.search_attendance, name='search_attendance'),
        path('user_dtr/', views.u_search_attendance, name='u_search_attendance'),
        ...
        path('edit_logs/', views.u_edit_logs, name='u_edit_logs'),
